...
using ip_pool_t_const_it =
    std::vector<std::vector<std::string>>::const_iterator;

std::vector<std::string> split(const std::string &str, char d);

int read_file(ip_pool_t &ip_pool, const char *file_name);
...
void print_filtered(const ip_pool_t &ip_pool, Pred pred, std::ostream &os = std::cout);
